...
<body>
	...
	<form action="process-form.php" method="post" enctype="multipart/form-data">
		...
		<div>
			<label for="gender">Gender:</label>
			<select name="gender[]" id="gender" required Multiple>
				<option value="">Please select</option>
				<option value="M" selected>Male</option>				
				<option value="F">Female</option>
			</select>
		...
		<div>
			<label for="myfile">Upload File:</label>  <!--  if you file upload you need to put this into form " enctype="multipart/form-data"   "  and method is need to be POST -->
